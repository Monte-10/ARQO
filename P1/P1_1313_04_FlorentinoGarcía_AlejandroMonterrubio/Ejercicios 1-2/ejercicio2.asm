...
copy_loop:
    ...
    addi a2, a2, -1        # Reducimos en 1 el contador
    bnez a2, copy_loop     # Si el contador no es cero, repetimos el bucle

    # Realizamos BubbleSort ascendente
    li a4, 9               # Contador para el bucle externo
outer_loop:
    li a5, 0               # Contador para el bucle interno
...
inner_loop:
    ...
    blt a6, a7, skip_swap  # Si el valor actual es menor al siguiente, saltamos al intercambio
